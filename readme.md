...
ก่อนส่งงานหรือพักงาน ควรตรวจรายการเหล่านี้

- MongoDB เชื่อมต่อ database `homeofhearts` ถูกตัว
- `SESSION_SECRET` ถูกตั้งค่าแล้ว
- admin login ได้
- user login ได้ด้วยเลขห้อง/อีเมลตามที่ระบบกำหนด
- หน้า admin dashboard แสดงข้อมูลจริงจากแต่ละระบบ
